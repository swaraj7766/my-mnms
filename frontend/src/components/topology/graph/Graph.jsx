...
export default class Graph extends React.Component {
  ...
  _zoomConfig = () => {
    ...
    const zoomObject = d3Zoom().scaleExtent([
    ...
    if (this.state.config.collapsible) {
      ...
      this._tick(
        ...
        () => {
          this.props.onClickNode &&
            this.props.onClickNode(clickedNodeId, clickedNode);
      ...
      if (!this.nodeClickTimer) {
        ...
        this.props.onDoubleClickNode &&
          this.props.onDoubleClickNode(clickedNodeId, clickedNode);
  ...
  onRightClickNode = (event, id) => {
    ...
    this.props.onRightClickNode &&
      this.props.onRightClickNode(event, id, clickedNode);
  };
  ...
  UNSAFE_componentWillReceiveProps(nextProps) {
    const { graphElementsUpdated, newGraphElements } =
